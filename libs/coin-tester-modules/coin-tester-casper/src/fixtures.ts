...
import type { CasperAccount } from "@ledgerhq/coin-casper/types";
...
export const DERIVATION_MODE = "casper_wallet";
...
/** The transfer under test: user0 sends, user1 receives. Both are prefunded at genesis. */
 ...
 * passes localhost through for the devnet RPC and throws for every other host,
 * so an indexer path we do not handle fails loudly.
 */
export const MOCK_INDEXER_URL = "http://casper-indexer.mock/";
