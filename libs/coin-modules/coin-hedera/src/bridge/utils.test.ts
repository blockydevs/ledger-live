...
describe("bridge utils", () => {
  describe("getSyncHash", () => {
    ...
    it("produces different hash if blacklistedTokenIds changes", () => {
      const hash1 = getSyncHash(mockedCurrency, []);
  ...
  describe("prepareOperations", () => {
    ...
    it("links token operation to existing coin operation with matching hash", () => {
    ...
    it("creates NONE coin operation as parent if no coin op with matching hash exists", () => {
      const mockedTokenAccount = getMockedTokenAccount(tokenCurrencyFromCAL);
