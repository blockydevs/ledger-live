...
- [#18166](https://github.com/LedgerHQ/ledger-live/pull/18166) [`d5b2f4e`](https://github.com/LedgerHQ/ledger-live/commit/d5b2f4e2e993927d3123c026b693ceffc9075235) Thanks [@estrauser-ledger](https://github.com/estrauser-ledger)! - Fix: include operations for failed transactions instead of discarding them, so downstream consumers (A4, lama-adapter) can see transfer details (asset, amount, sender, recipient) while using the `failed` flag to exclude them from balance computation.

- [#17916](https://github.com/LedgerHQ/ledger-live/pull/17916) [`622ffed`](https://github.com/LedgerHQ/ledger-live/commit/622ffedb5071de066f0e6ffee3639740081a2c17) Thanks [@hedi-edelbloute](https://github.com/hedi-edelbloute)! - fix: coin-tron disable-network-setup

- [#18192](https://github.com/LedgerHQ/ledger-live/pull/18192) [`0b2e53e`](https://github.com/LedgerHQ/ledger-live/commit/0b2e53eed0579bd9563669934f4f71461ec25e4e) Thanks [@jnicoulaud-ledger](https://github.com/jnicoulaud-ledger)! - fix(VSD-5287): fix tron crafting not allowing customFee=0

- [#17835](https://github.com/LedgerHQ/ledger-live/pull/17835) [`49c6e1f`](https://github.com/LedgerHQ/ledger-live/commit/49c6e1fa4819a1eb372314d92f8e486395da3eae) Thanks [@YazhuEth](https://github.com/YazhuEth)! - Fix coin-framework `estimateFees` to use real on-chain data (chain parameters, simulated energy via triggerConstantContract) instead of hardcoded constants, and stop adding the 1.1 TRX native activation fee on TRC20/TRC10 transfers to inactive recipients
...
- [#16217](https://github.com/LedgerHQ/ledger-live/pull/16217) [`13faa62`](https://github.com/LedgerHQ/ledger-live/commit/13faa62f0c2c7b6102c4ba33bdfed77354403860) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - chore(coin-tron): remove preload and hydrate - do not fetch validators metadata

- [#16139](https://github.com/LedgerHQ/ledger-live/pull/16139) [`b947b41`](https://github.com/LedgerHQ/ledger-live/commit/b947b41f72f2318d720cecc4ebf8c32bab804c90) Thanks [@estrauser-ledger](https://github.com/estrauser-ledger)! - Fix feesPayer for trc20 txs
...
- [#16180](https://github.com/LedgerHQ/ledger-live/pull/16180) [`9e1834c`](https://github.com/LedgerHQ/ledger-live/commit/9e1834c678277314ba8b58ce88b37b445c26737d) Thanks [@estrauser-ledger](https://github.com/estrauser-ledger)! - Propagate an error when TronGrid returns an empty page.

- [#16295](https://github.com/LedgerHQ/ledger-live/pull/16295) [`95700d0`](https://github.com/LedgerHQ/ledger-live/commit/95700d0402857a170e17448143dc906056eddc1c) Thanks [@estrauser-ledger](https://github.com/estrauser-ledger)! - Fix missing assets from tx

- [#16040](https://github.com/LedgerHQ/ledger-live/pull/16040) [`88e9f22`](https://github.com/LedgerHQ/ledger-live/commit/88e9f22073efffc960c74dcf5ab3d47bad0628f7) Thanks [@estrauser-ledger](https://github.com/estrauser-ledger)! - proper error on limit > 200 on tron listOperations
...
- [#15923](https://github.com/LedgerHQ/ledger-live/pull/15923) [`9f7ca82`](https://github.com/LedgerHQ/ledger-live/commit/9f7ca82d3e9768e2f06554af3cdf54cd4f414621) Thanks [@estrauser-ledger](https://github.com/estrauser-ledger)! - add pagination for alpaca tron listOperations
...
- [#15345](https://github.com/LedgerHQ/ledger-live/pull/15345) [`eb09fba`](https://github.com/LedgerHQ/ledger-live/commit/eb09fba0a7c2beabd09775a60a98196f96413f17) Thanks [@estrauser-ledger](https://github.com/estrauser-ledger)! - Replace N calls by a single call to get fees in tron getBlock
...
- [#15212](https://github.com/LedgerHQ/ledger-live/pull/15212) [`d792ba7`](https://github.com/LedgerHQ/ledger-live/commit/d792ba7badd7107f906bd822a7d139627c093186) Thanks [@estrauser-ledger](https://github.com/estrauser-ledger)! - add getBlock for alpaca
...
- [#14213](https://github.com/LedgerHQ/ledger-live/pull/14213) [`8af6bf7`](https://github.com/LedgerHQ/ledger-live/commit/8af6bf761029a99f69a88ef8cc39f58b0cdcef18) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - chore(coin-tron): log when error is a string
...
- [#13931](https://github.com/LedgerHQ/ledger-live/pull/13931) [`e0f9f89`](https://github.com/LedgerHQ/ledger-live/commit/e0f9f890ffde96b8cb6b7d74a99bd7384fbe1c84) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - chore(coin-tron): log some info on "Invalid extension provided"
...
- [#12579](https://github.com/LedgerHQ/ledger-live/pull/12579) [`a1285b1`](https://github.com/LedgerHQ/ledger-live/commit/a1285b183e770eb1695014d5531dcde5a4c48265) Thanks [@jnicoulaud-ledger](https://github.com/jnicoulaud-ledger)! - [coin modules][tron] fix POST requests to TronGrid returning errors with empty message
