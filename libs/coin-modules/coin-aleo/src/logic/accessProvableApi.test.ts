...
const mockRegisterNewAccount = apiClient.registerNewAccount as jest.MockedFunction<
  typeof apiClient.registerNewAccount
>;
const mockGetAccountJWT = apiClient.getAccountJWT as jest.MockedFunction<
  typeof apiClient.getAccountJWT
>;
const mockRegisterForScanningAccountRecords =
  apiClient.registerForScanningAccountRecords as jest.MockedFunction<
    typeof apiClient.registerForScanningAccountRecords
  >;
const mockGetRecordScannerStatus = apiClient.getRecordScannerStatus as jest.MockedFunction<
  typeof apiClient.getRecordScannerStatus
>;
const mockGenerateUniqueUsername = utils.generateUniqueUsername as jest.MockedFunction<
  typeof utils.generateUniqueUsername
>;
